 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uh="[DEFAULT]",KT={[lh]:"fire-core",[_T]:"fire-core-compat",[TT]:"fire-analytics",[IT]:"fire-analytics-compat",[CT]:"fire-app-check",[kT]:"fire-app-check-compat",[NT]:"fire-auth",[DT]:"fire-auth-compat",[AT]:"fire-rtdb",[RT]:"fire-rtdb-compat",[xT]:"fire-fn",[PT]:"fire-fn-compat",[OT]:"fire-iid",[LT]:"fire-iid-compat",[MT]:"fire-fcm",[$T]:"fire-fcm-compat",[UT]:"fire-perf",[FT]:"fire-perf-compat",[bT]:"fire-rc",[VT]:"fire-rc-compat",[BT]:"fire-gcs",[jT]:"fire-gcs-compat",[zT]:"fire-fst",[HT]:"fire-fst-compat","fire-js":"fire-js",[WT]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ro=qT;function Qv(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:uh,automaticDataCollectionEnabled:!1},e),i=r.name;if(typeof i!="string"||!i)throw Pn.create("bad-app-name",{appName:String(i)});if(n||(n=WI()),!n)throw Pn.create("no-options");const s=Ps.get(i);if(s){if(Qa(n,s.options)&&Qa(r,s.config))return s;throw Pn.create("duplicate-app",{appName:i})}const o=new iT(i);for(const l of ch.values())o.addComponent(l);const a=new YT(n,r,o);return Ps.set(i,a),a}function Fd(t=uh){const e=Ps.get(t);if(!e&&t===uh)return Qv();if(!e)throw Pn.create("no-app",{appName:t});return e}function XT(){return Array.from(Ps.values())}function On(t,e,n){var r;let i=(r=KT[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${i}" with version "${e}":`];s&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),vr.warn(a.join(" "));return}ci(new yr(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hR(t,e,n=!1){const{auth:r}=t,i="reauthenticate";try{const s=await qs(t,M1(r,i,e,t),n);$(s.idToken,r,"internal-error");const o=$f(s.idToken);$(o,r,"internal-error");const{sub:a}=o;return $(t.uid===a,r,"user-mismatch"),_r._forOperation(t,i,s)}catch(s){throw(s==null?void 0:s.code)==="auth/user-not-found"&&At(r,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
